...
Для самостоятельной сборки устройства вам потребуется устойство [smalltv или smalltv-ultra](https://www.aliexpress.com/w/wholesale-smalltv-wifi.html). Обратите внимание есть еще smalltv-pro они внешне одинаковы, но отличаются по внутренней начинке. Проект работает только на smalltv, smalltv-ultra. Дополнительно вам понадобятся:
